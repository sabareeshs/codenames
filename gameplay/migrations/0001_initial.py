# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-05-21 03:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Board',
            fields=[
                ('turn', models.CharField(choices=[(b'BLUEAGENT', 'BA'), (b'BLUEMASTER', 'BM'), (b'REDAGENT', 'RA'), (b'REDMASTER', 'RM')], default=gameplay.models.Turn('BM'), max_length=10)),
